...
for(a in names(spl)){
  ...
  table(seu.fibro[[a]]$scGate_multi) %>% print()
  
  table(Allsamples_onlyFibroblast_fineannot[[a]]$scGate_multi) %>% print()
}
...
for(a in names(spl)){
  ...
  table(spl[[a]]$annotation) %>% print()
  
  table(WHexp_hitme_annotated[[a]]$annotation) %>% print()
}
```
