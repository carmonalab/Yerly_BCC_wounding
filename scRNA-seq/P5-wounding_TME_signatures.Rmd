...
# Obtain wounding signatures of Fibroblasts, MoMac, panDc and pericytes
...
ct <- c("Fibroblast", "MoMac", "panDC", "Perycyte")
...
sigs <- lapply(ct,
               function(c){
                 ...
                 ntop = 1000 # limit number of genes
...
saveRDS(sigs, "cache/Wounding_signatures.rds")
```


This signatures will be then used in scripts P6*.Rmd for scoring the wound response in respectrive cell types in retrospective BCC samples.
